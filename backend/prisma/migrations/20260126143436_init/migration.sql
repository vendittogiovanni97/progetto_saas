...
CREATE TABLE `Chatbot` (
    ...
    `welcomeMessage` VARCHAR(191) NOT NULL DEFAULT 'Ciao! Come posso aiutarti?',
    ...
    INDEX `Chatbot_accountId_idx`(`accountId`),
    INDEX `Chatbot_createdAt_idx`(`createdAt`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `Chatbot` ADD CONSTRAINT `Chatbot_accountId_fkey` FOREIGN KEY (`accountId`) REFERENCES `Account`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
